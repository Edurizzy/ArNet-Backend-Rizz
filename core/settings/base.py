"""
Base Django settings for ArNet project.

This module contains settings common to all environments.
Environment-specific settings should be placed in separate modules
(local.py, production.py, etc.) and import from this base.
"""
...
env = environ.Env(
    ...
    ALLOWED_HOSTS=(list, []),
    DATABASE_URL=(str, 'postgresql://postgres:postgres@localhost:5432/arnet_dev'),
)
...
MIDDLEWARE = [
    ...
    'core.tenancy.middleware.TenancyMiddleware',  # Custom tenant middleware
...
# JWT Configuration
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=env.int('JWT_ACCESS_TOKEN_LIFETIME', 30)),
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': env('LOG_FILE_PATH', default=BASE_DIR / 'logs' / 'django.log'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'ArNet API',
    'DESCRIPTION': 'Enterprise SaaS AI-First Platform API',
    'VERSION': '1.0.0',
